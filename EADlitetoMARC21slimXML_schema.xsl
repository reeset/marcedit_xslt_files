...
<xsl:stylesheet version="1.0" xmlns:ead="urn:isbn:1-931666-22-9" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <xsl:import href="MARC21slimUtils.xsl" />
	...
	<xsl:template match="/*[local-name()='ead']">
		<marc:collection xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
			...
			<xsl:variable name="bulkdate" select="//*[local-name()='unitdate']" />
			...
			<marc:record>
				...
				<xsl:choose>
					<xsl:when test="$bulkdate!='' and string-length(substring-before($bulkdate, '-'))=4">
				...
				-->
				<xsl:if test="//*[local-name()='unitid']">
					<marc:datafield tag="099" ind1=" " ind2=" ">
						<marc:subfield code="a">ARCH-MSS</marc:subfield>
					</marc:datafield>
				</xsl:if>
			  <xsl:if test="//*[local-name()='origination']">
			    <xsl:if test="//*[local-name()='origination'][*[local-name()='persname']][@role='creator']">
						<xsl:call-template name="persname_template">
						  <xsl:with-param name="string" select="normalize-space(//*[local-name()='origination']/*[local-name()='persname']/.)" />
			    ...
			    <xsl:if test="//*[local-name()='origination'][@label='creator']/*[local-name()='persname']">
						<xsl:call-template name="persname_template">
						  <xsl:with-param name="string" select="normalize-space(//*[local-name()='origination']/*[local-name()='persname']/.)" />
							<xsl:with-param name="field" select="'100'" />
							<xsl:with-param name="ind1" select="'1'" />
			    ...
			    <xsl:if test="//*[local-name()='origination']/*[local-name()='famname'][@role='creator']">
						<xsl:call-template name="persname_template">
						  <xsl:with-param name="string" select="normalize-space(//*[local-name()='origination']/*[local-name()='famname']/.)" />
							<xsl:with-param name="field" select="'100'" />
							<xsl:with-param name="ind1" select="'1'" />
							<xsl:with-param name="ind2" select="' '" />
						</xsl:call-template>
			    ...
			    <xsl:if test="//*[local-name()='origination']/*[local-name()='corpname'][@role='creator']">
						<xsl:call-template name="corpname_template">
						  <xsl:with-param name="string" select="normalize-space(//*[local-name()='origination']/*[local-name()='corpname']/.)" />
			    ...
			    <xsl:if test="//*[local-name()='origination'][@label='creator']/*[local-name()='corpname']">
						<xsl:call-template name="corpname_template">
						  <xsl:with-param name="string" select="normalize-space(//*[local-name()='origination']/*[local-name()='corpname']/.)" />
							<xsl:with-param name="field" select="'110'" />
							<xsl:with-param name="ind1" select="'2'" />
			  ...
			  <xsl:if test="//*[local-name()='unittitle']">
					<marc:datafield tag="245" ind1="1" ind2="0">
						<xsl:choose>
						  <xsl:when test="//*[local-name()='unitdate']">
								<marc:subfield code="a">
								  <xsl:value-of select="normalize-space(//*[local-name()='unittitle']/.)" />,
								</marc:subfield>
							</xsl:when>
							<xsl:otherwise>
								<marc:subfield code="a">
					  ...
					  <xsl:if test="//*[local-name()='unitdate']">
							<xsl:choose>
							  <xsl:when test="//*[local-name()='unitdate']/@encodinganalog='245$g'">
							    <xsl:if test="//*[local-name()='unitdate']/@encodinganalog='245$f'">
							      <marc:subfield code="f"><xsl:value-of select="normalize-space(//*[local-name()='unitdate'][@encodinganalog='245$f']/.)" /></marc:subfield>
									</xsl:if>
							    <xsl:if test="//*[local-name()='unitdate']/@encodinganalog='245$g'">
							      <marc:subfield code="g">bulk <xsl:value-of select="normalize-space(//*[local-name()='unitdate'][@encodinganalog='245$g']/.)" />).</marc:subfield>
									</xsl:if>
								</xsl:when>
								<xsl:otherwise>
								  <xsl:if test="//*[local-name()='unitdate']/@encodinganalog='245$f'">
			  ...
			  <xsl:if test="*[local-name()='archdesc']/*[local-name()='did']/*[local-name()='physdesc']">
				  <xsl:for-each select="*[local-name()='archdesc']/*[local-name()='did']/*[local-name()='physdesc']/*[local-name()='extent']">
			  ...
			  <xsl:if test="*[local-name()='archdesc']/*[local-name()='arrangement']">
					<marc:datafield tag="351" ind1=" " ind2=" ">
						<marc:subfield code="a">
						  <xsl:value-of select="normalize-space(*[local-name()='archdesc']/*[local-name()='arrangement']/.)" />
						</marc:subfield>
					</marc:datafield>
				</xsl:if>
			  <xsl:for-each select="//*[local-name()='odd']">
			  ...
			  <xsl:if test="//*[local-name()='accessrestrict']">
					<marc:datafield tag="506" ind1=" " ind2=" ">
						<marc:subfield code="a">
						  <xsl:value-of select="normalize-space(//*[local-name()='accessrestrict']/.)" />
						</marc:subfield>
					</marc:datafield>
				</xsl:if>
				...
				<xsl:choose>
				  <xsl:when test="//*[local-name()='scopecontent']">
						<marc:datafield tag="520" ind1="2" ind2=" ">
							<marc:subfield code="a">
							  <xsl:value-of select="normalize-space(//*[local-name()='scopecontent']/*[local-name()='p']/.)" />
							</marc:subfield>
						</marc:datafield>
					</xsl:when>
					<xsl:otherwise>
					  <xsl:if test="//*[local-name()='abstract']">
					    <xsl:if test="//*[local-name()='abstract']/@encodinganalog='5203_'">
								<marc:datafield tag="520" ind1="3" ind2=" ">
									<marc:subfield code="a">
									  <xsl:value-of select="normalize-space(//*[local-name()='abstract']/*[local-name()='p']/.)" />
									</marc:subfield>
								</marc:datafield>
							</xsl:if>
					    <xsl:if test="//*[local-name()='abstract']/@encodinganalog != '5203_'">
			  ...
			  <xsl:if test="*[local-name()='archdesc']/*[local-name()='prefercite']">
					<marc:datafield tag="524" ind1=" " ind2=" ">
						<marc:subfield code="a">
						  <xsl:value-of select="normalize-space(*[local-name()='archdesc']/*[local-name()='prefercite']/.)" />
						</marc:subfield>
					</marc:datafield>
				</xsl:if>
			  <xsl:if test="//*[local-name()='fileplan']/*[local-name()='altformavail']">
					<marc:datafield tag="530" ind1=" " ind2=" ">
						<marc:subfield code="a">
						  <xsl:value-of select="normalize-space(//*[local-name()='fileplan']/*[local-name()='altformavail']/.)" />
						</marc:subfield>
					</marc:datafield>
				</xsl:if>
			  <xsl:if test="//*[local-name()='legalstatus']/*[local-name()='userestrict']">
					<marc:datafield tag="540" ind1=" " ind2=" ">
						<marc:subfield code="a">
						  <xsl:value-of select="normalize-space(//*[local-name()='legalstatus']/*[local-name()='userestrict']/.)" />
						</marc:subfield>
					</marc:datafield>
				</xsl:if>
			  <xsl:if test="*[local-name()='archdesc']/*[local-name()='relatedmaterial']">
					<marc:datafield tag="544" ind1="1" ind2=" ">
						<marc:subfield code="a">
						  <xsl:value-of select="normalize-space(*[local-name()='archdesc']/*[local-name()='relatedmaterial']/.)" />
						</marc:subfield>
					</marc:datafield>
				</xsl:if>
			  <xsl:if test="//*[local-name()='bioghist']">
			    <xsl:if test="//*[local-name()='bioghist']/@encodinganalog='5450_'">
						<marc:datafield tag="545" ind1="0" ind2=" ">
							<marc:subfield code="a">
							  <xsl:value-of select="normalize-space(//*[local-name()='bioghist']/*[local-name()='p']/.)" />
							</marc:subfield>
						</marc:datafield>
					</xsl:if>
			    <xsl:if test="//*[local-name()='bioghist']/@encodinganalog='5451_'">
			    ...
			    <xsl:if test="//*[local-name()='bioghist']/@encodinganalog='545' or //*[local-name()='bioghist']/@encodinganalog='545$a'">
			    ...
			    <xsl:if test="//*[local-name()='bioghist']/@encodinganalog = ''">
            <marc:datafield tag="545" ind1=" " ind2=" ">
              <marc:subfield code="a">
                <xsl:value-of select="normalize-space(//*[local-name()='bioghist']/*[local-name()='p']/.)" />
              </marc:subfield>
			  ...
			  <xsl:if test="//*[local-name()='langmaterial']/*[local-name()='language']">
          <xsl:choose>
            <xsl:when test="normalize-space(//*[local-name()='langmaterial']/*[local-name()='language']/.) != ''">
              <marc:datafield tag="546" ind1=" " ind2=" ">
                <marc:subfield code="a">Materials in <xsl:value-of select="normalize-space(//*[local-name()='langmaterial']/*[local-name()='language']/.)" />
                </marc:subfield>
              </marc:datafield>
            </xsl:when>
            <xsl:otherwise>
              <marc:datafield tag="546" ind1=" " ind2=" ">
                <marc:subfield code="a">Materials in <xsl:value-of select="normalize-space(//*[local-name()='langmaterial']/*[local-name()='language']/@langcode)" />
                </marc:subfield>
              </marc:datafield>
            </xsl:otherwise>
          </xsl:choose>
			  ...
			  <xsl:if test="*[local-name()='archdesc']/*[local-name()='custodhist']">
					<marc:datafield tag="561" ind1=" " ind2=" ">
						<marc:subfield code="a">
						  <xsl:value-of select="normalize-space(*[local-name()='archdesc']/*[local-name()='custodhist']/.)" />
						</marc:subfield>
					</marc:datafield>
				</xsl:if>
        
			  <xsl:for-each select="//*[local-name()='controlaccess']/*[local-name()='persname']">
            ...
            <xsl:otherwise>
			  ...
			  <xsl:for-each select="//*[local-name()='controlaccess']/*[local-name()='corpname']">
          <xsl:sort select="@encodinganalog" />
          <xsl:choose>
            ...
            <xsl:otherwise>
			  ...
			  <xsl:for-each select="//*[local-name()='controlaccess']/*[local-name()='subject'][@source='lcsh'] | //*[local-name()='controlaccess']/*[local-name()='geogname'][@source='lcsh']">
					<xsl:choose>
			  ...
			  <xsl:for-each select="//*[local-name()='controlaccess']/*[local-name()='genreform']">
			  ...
			  <xsl:for-each select="//*[local-name()='controlaccess']/*[local-name()='title']">
					<xsl:choose>
				...
				-->
			  <xsl:if test="*[local-name()='eadheader']/*[local-name()='eadid']">
					<marc:datafield tag="856" ind1="4" ind2="2">
						<marc:subfield code="u">
						  <xsl:variable name="url" select="normalize-space(*[local-name()='eadheader']/*[local-name()='eadid']/@url)" />
							<xsl:if test="$url!=''">
							  <xsl:value-of select="normalize-space(*[local-name()='eadheader']/*[local-name()='eadid']/@url)" />
							</xsl:if>
							<xsl:if test="$url=''">
							  <xsl:if test="*[local-name()='eadheader']/*[local-name()='eadid']/@publicid !=''">
							    <xsl:value-of select="normalize-space(*[local-name()='eadheader']/*[local-name()='eadid']/@publicid)" />
								</xsl:if>
							</xsl:if>
						</marc:subfield>
						<marc:subfield code="z">View the EAD finding aid.</marc:subfield>
					</marc:datafield>
				</xsl:if>
   ...
   <xsl:template name="persname_template">
      ...
      <marc:datafield>
            ...
            <xsl:when test="contains($string, '-')!=0">
               ...
               <xsl:choose>
                  ...
                  <xsl:when test="translate(substring($name_1, (string-length($name_1)), 1), '0123456789', '9999999999') = '9'">
                     <xsl:variable name="name" select="normalize-space(substring($name_1, 1, (string-length($name_1)-6)))" />
                     <marc:subfield code="a">
                  ...
                  <xsl:otherwise>
                     ...
                     <xsl:choose>
                        ...
                        <xsl:when test="contains($remainder, '-')!=0">
                           ...
                           <marc:subfield code="a">
                              <xsl:value-of select="normalize-space($name_1)" />-<xsl:value-of select="$name_2" />
                           </marc:subfield>
                        </xsl:when>
         ...
         <xsl:if test="contains($string, '(')!=0">
            ...
            <marc:subfield code="q">(<xsl:value-of select="normalize-space($subq)" />)</marc:subfield>
         </xsl:if>
            ...
            <xsl:choose>
               ...
               <xsl:when test="contains($remainder, '-')!=0">
                  ...
                  <xsl:if test="translate(substring($date_1, 1, 1), '0123456789', '9999999999') = '9'">
                     <marc:subfield code="d">
                        <xsl:value-of select="normalize-space($date_1)" />.
                     </marc:subfield>
                  </xsl:if>
               </xsl:when>
               ...
               <xsl:otherwise>
                  ...
                  <xsl:if test="translate(substring($date_2, 1, 1), '0123456789', '9999999999') = '9'">
                     <marc:subfield code="d">
                        <xsl:value-of select="normalize-space($date_2)" />.
                     </marc:subfield>
                  </xsl:if>
               </xsl:otherwise>
            </xsl:choose>
  ...
  <xsl:template name="get_file">
    ...
    <xsl:choose>
      ...
      <xsl:when test="contains($string, '--')!=0">
        <xsl:variable name="str1" select="substring-before($string, '--')" />
        <xsl:variable name="str2" select="substring-after($string, '--')" />
        <marc:subfield code="x"><xsl:value-of select="$str1" /></marc:subfield>
        <xsl:call-template name="corpname_tokenizeb">
          <xsl:with-param name="string" select="$str2" />
          <xsl:with-param name="type" select="'x'" />
        </xsl:call-template>
      ...
      <xsl:otherwise>
        <xsl:if test="$type='b'">
          <marc:subfield code="b"><xsl:value-of select="$string" /></marc:subfield>
        </xsl:if>
        <xsl:if test="$type='x'">
          <marc:subfield code="x"><xsl:value-of select="$string" /></marc:subfield>
        </xsl:if>
      </xsl:otherwise>
    </xsl:choose>
	</xsl:template>
